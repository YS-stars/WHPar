...
tf.flags.DEFINE_integer('decay_steps', 10000, 'Learning rate decay steps')  # Learning rate decay
tf.flags.DEFINE_integer('evaluate_every_steps', 10, 'Evaluate the model on validation set after this many steps')
